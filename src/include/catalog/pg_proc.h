...
DESCR("I/O");
DATA(insert OID = 6124 (  fhe_intrecv			   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 20 "2281" _null_ _null_ _null_ _null_ _null_	fhe_intrecv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 6125 (  fhe_intsend			   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 17 "20" _null_ _null_ _null_ _null_ _null_ fhe_intsend _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 6128 (  fhe_floatrecv		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 701 "2281" _null_ _null_ _null_ _null_ _null_ fhe_floatrecv _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 6129 (  fhe_floatsend		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 17 "701" _null_ _null_ _null_ _null_ _null_ fhe_floatsend _null_ _null_ _null_ ));
DESCR("I/O");
...
DATA(insert OID = 6122 (  fhe_intin			   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 20 "2275" _null_ _null_ _null_ _null_ _null_ fhe_intin _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 6123 (  fhe_intout		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 2275 "20" _null_ _null_ _null_ _null_ _null_ fhe_intout _null_ _null_ _null_ ));
DESCR("I/O");
...
// DATA(insert OID = 465 (  int8mul		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 20 "20 20" _null_ _null_ _null_ _null_ _null_ int8mul _null_ _null_ _null_ ));
// DATA(insert OID = 466 (  int8div		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 20 "20 20" _null_ _null_ _null_ _null_ _null_ int8div _null_ _null_ _null_ ));
// DATA(insert OID = 467 (  fhe_inteq			   PGNSP PGUID 12 1 0 0 0 f f f t t f i s 2 0 16 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_inteq _null_ _null_ _null_ ));
// DATA(insert OID = 468 (  fhe_intne			   PGNSP PGUID 12 1 0 0 0 f f f t t f i s 2 0 16 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_intne _null_ _null_ _null_ ));
// DATA(insert OID = 469 (  fhe_intlt			   PGNSP PGUID 12 1 0 0 0 f f f t t f i s 2 0 16 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_intlt _null_ _null_ _null_ ));
// DATA(insert OID = 470 (  fhe_intgt			   PGNSP PGUID 12 1 0 0 0 f f f t t f i s 2 0 16 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_intgt _null_ _null_ _null_ ));
// DATA(insert OID = 471 (  fhe_intle			   PGNSP PGUID 12 1 0 0 0 f f f t t f i s 2 0 16 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_intle _null_ _null_ _null_ ));
// DATA(insert OID = 472 (  fhe_intge			   PGNSP PGUID 12 1 0 0 0 f f f t t f i s 2 0 16 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_intge _null_ _null_ _null_ ));
// DATA(insert OID = 1236 (  fhe_intlarger	   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 20 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_intlarger _null_ _null_ _null_ ));
// DESCR("larger of two");
// DATA(insert OID = 1237 (  int8smaller	   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 2 0 20 "20 20" _null_ _null_ _null_ _null_ _null_ fhe_intsmaller _null_ _null_ _null_ ));
// DESCR("smaller of two");
DATA(insert OID = 6126 (  fhe_floatin		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 701 "2275" _null_ _null_ _null_ _null_ _null_ float8in _null_ _null_ _null_ ));
DESCR("I/O");
DATA(insert OID = 6127 (  fhe_floatout		   PGNSP PGUID 12 1 0 0 0 f f f f t f i s 1 0 2275 "701" _null_ _null_ _null_ _null_ _null_ float8out _null_ _null_ _null_ ));
DESCR("I/O");
